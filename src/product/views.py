...
from product.serializers import ProductUnitSeriaizer,ProductVariantSeriaizer,ProductvariantAttributeSeriaizer,ProductVariantReviewSeriaizer,CartItemSerializer,CountryWiseProductVariantSerializer
...
class UserCartItemListCreateAPIView(ListCreateAPIView):
    ...
    search_fields=['product_variant__name', 'product_variant__slug','product_variant__id']
